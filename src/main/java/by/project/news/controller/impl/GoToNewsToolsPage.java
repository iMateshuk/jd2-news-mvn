...
public class GoToNewsToolsPage implements Command {
	...
	private final static Logger log = LogManager.getLogger(GoToNewsToolsPage.class);

	private final static String PATH = "/WEB-INF/jsp/" + CommandName.NEWS_TOOLS.toString().toLowerCase() + ".jsp";
