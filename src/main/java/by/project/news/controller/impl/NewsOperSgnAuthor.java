...
public class NewsOperSgnAuthor implements Command {
	...
	private final static Logger log = LogManager.getLogger(NewsOperSgnAuthor.class);
	...
	private final static String REDIRECT = COMMAND + commandAnswer + ACTION + commandSGN;
